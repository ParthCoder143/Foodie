    ...
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string downloadPath = Server.MapPath("~/Images/User/Invoice/Invoice" + DateTime.UtcNow.ToString("dd-MM-yyyy-HH-mm-ss")+".pdf");
        ...
        void ExportToPdf(System.Data.DataTable dtblTable, string strPdfPath, string strHeader)
        {
