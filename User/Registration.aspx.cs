...
namespace Foodie.User
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Utils.IsValidExtrension(fuUserImage.FileName))
                {
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                        " registration is Successful!<b> <a href='Login.aspx'> Click Here </a> </b> to do login" : " details updated Successful!  <b><a href='Profile.aspx'> Can Check Here </a> </b>";
                    lblMsg.Visible = true;
