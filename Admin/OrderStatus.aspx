<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="Foodie.Admin.Order_Status" %>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td class="tabke-plus"><%# Eval("OrderNo") %></td>
                                                                <td>
                                                                    <%# Eval("OrderDate") %>
                                                                </td>
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rdvDdlOrderStatus" runat="server" ErrorMessage="Order Status is Required" 
                                                            SetFocusOnError="true" Display="Dynamic" ForeColor="Red" ControlToValidate="ddlOrderStatus" InitialValue="0"></asp:RequiredFieldValidator>
