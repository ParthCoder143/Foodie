                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="Product.aspx"><i class="text-c-pink f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="OrderStatus.aspx"><i class="text-c-green f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="OrderStatus.aspx"><i class="text-c-yellow f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="OrderStatus.aspx"><i class="text-c-blue f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <span class="text-c-pink f-w-600">User Social</span>
                                    <h4><% Response.Write(Session["user"]); %></h4>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="Users.aspx"><i class="text-c-pink f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="Report.aspx"><i class="text-c-green f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                    ...
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                                            <a href="Contacts.aspx"><i class="text-c-yellow f-16 icofont icofont-eye-alt"></i>View Details</a>
                                        </span>
                                    </div>
                                </div>
