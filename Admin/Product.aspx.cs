...
namespace Foodie.Admin
{
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("Product_Cruds", con);
            ...
            {
                if (Utils.IsValidExtrension(fuProductImage.FileName))
                {
        ...
        protected void rProduct_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            if (e.CommandName == "edit")
            {
                ...
                imgProduct.ImageUrl = string.IsNullOrEmpty(dt.Rows[0]["ImageUrl"].ToString()) ? "../Image/No_image.png" : "../" + dt.Rows[0]["ImageUrl"].ToString();
        ...
        protected void rproduct_Itemdatabound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Label lbl2 = e.Item.FindControl("lblquantity") as Label;
                if (lbl.Text == "True")
                {
                    lbl.Text = "Active";
                ...
                if (Convert.ToInt32(lbl2.Text) <= 5)
                {
                    lbl2.CssClass = "badge badge-danger";
                    lbl2.ToolTip = "item about to be out of stock!";
