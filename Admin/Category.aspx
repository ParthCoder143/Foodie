                                            ...
                                            <div class ="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                                ...
                                                <div class="card-block table-border-style">
                                                    <div class ="table-responsive">
                                                           ...
                                                           <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemControl"  OnItemDataBound="rCategory_ItemDataBound">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" CommandName="edit" CssClass="badge badge-primary" CommandArgument='<%# Eval("CategoryId") %>'>
                                                                            <i class="ti-pencil"></i>
                                                                        </asp:LinkButton>
                                                                       <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" CommandName="delete" CssClass="badge bg-danger" CommandArgument='<%# Eval("CategoryId") %>' OnClientClick="return confirm('Do You Want To Delete This Category?');">
